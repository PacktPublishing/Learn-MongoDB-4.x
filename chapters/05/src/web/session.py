...
class Session :
    ...
    def __init__(self, baseDir) :
        ...
        # TODO: run method which cleans out old session files
    ...
    """
    TODO!!! method which cleans out old session files past 1 day
    """
    def cleanOldSessFiles(self) :
        import glob
        sessFileList = glob.glob(self.baseDir + '/*.sess')
        for filename in sessFileList :
            print(filename)
            print(time.ctime(os.stat(filename).st_atime))
