# tests read/write with database "sweetscomplete"
...
client.sweetscomplete.test_collection.delete_many({})

# add a document to the "test_collection" collection
insert_result = client.sweetscomplete.test_collection.insert_one(data)

# retrieve the same document
find_result = client.sweetscomplete.test_collection.find_one()
